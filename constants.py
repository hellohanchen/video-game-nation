...
NBA_TEAM_IDS = {v: k for k, v in NBA_TEAMS.items()}
...
NBA_TEAM_NAME_TRICODES = {v: k for k, v in NBA_TEAM_NAMES.items()}
NBA_TEAM_NAME_IDS = {k: NBA_TEAMS[v] for k, v in NBA_TEAM_NAME_TRICODES.items()}
...
ERROR_MESSAGE = "Something went wrong, please retry or contact admin."
