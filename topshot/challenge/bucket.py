...
class Bucket:
    ...
    def add_date(self, date):
        ...
        :return: None
        """
        self.games.extend(games.get_games_on_date(date).keys())
    ...
    def get_current_ranking(self):
        ...
        """
        games_teams = games.get_teams_for_games(self.games)
        ...
        game_players = games.get_players_for_games(games_teams)
